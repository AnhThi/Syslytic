...
<html class=" ">
	<head>
		...
		<meta charset="utf-8" />
		<title>Syslytic Dashboard</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
		<meta content="" name="description" />
		<meta content="" name="author" />
		<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/back-end/images/favicon.png" type="image/x-icon" />    <!-- Favicon -->
		...
		<link href="<?php echo base_url(); ?>assets/back-end/plugins/pace/pace-theme-flash.css" rel="stylesheet" type="text/css" media="screen"/>
